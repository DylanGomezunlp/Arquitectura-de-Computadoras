...
color_7:        .word32 0x00808080
color_8:        .word32 0x00000000
...
###################################################################
; $a0 = x, $a1 = y, $a2 = cod color (1 o 8)
guardar_pixel:
   ;grafico[$a0*50+$a1] = $a2 ; grafico[x,y]
   dmuli $a0, $a0, 50
   dadd  $a0, $a0, $a1  ; $a0*50+$a1
   sb	   $a2, grafico($a0);  grafico[$a0*50+$a1] = $a2
   jr $ra


; $a0 = x, $a1 = y, $v0 = cod color (1 o 8)

recuperar_pixel:
   dmuli $a0, $a0, 50
   dadd  $a0, $a0, $a1  ; $a0*50+$a1
   lbu	 $v0, grafico($a0);  $v0 = grafico[$a0*50+$a1];grafico seria puntero y a0 el desplazamiento? 
   jr $ra
